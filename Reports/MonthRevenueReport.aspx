<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="MonthRevenueReport.aspx.vb" Inherits="MonthRevenueReport" %>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-report">
                <h2>Month Revenue Trend Report For: <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
			<div class="m"> 
				<ul id="submenu">
                    ...
                    <li><a href="#" class="active" >Month Revenue Report</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
