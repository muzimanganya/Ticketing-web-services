<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="BestRoutePerMonth.aspx.vb" Inherits="BestRoutePerMonth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-report">
                <h2>Month Best Route Report For: <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
			<div class="m"> 
				<ul id="submenu">
                    ...
                    <li><a href="#" class="active" >Month Best Routes</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
    <div id="element-box">
        <div class="m">
            <div class="cpanel-left" style="width:65% !important">
                <div id="week_chart" style="width:100%;height:400px"></div>
            </div>
            <div class="cpanel-right" style="width:34% !important">
                <div id="route_pie_chart" style="width:100%;height:400px"></div>
            </div>
        </div>
    </div>
</asp:Content>
