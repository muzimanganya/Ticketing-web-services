<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="VehicleList.aspx.vb" Inherits="DriverList" %>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-user">
                <h2>Vehicle List<asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
			<div class="m"> 
				<ul id="submenu">
		            ...
		            <li><a href="#" class="active" >Vehicle List</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
                            ...
                            <div class="driver" style="width:32%;float:left;margin-bottom:20px">
                                <div style="padding-left:5px;display:block">
                                    ...
                                    <div class="drvInfo" style="float:left;margin-left:10px">
                                        <h3><a href='VehicleEntry.aspx?VehicleNumber=<%# Eval("VehicleNumber")%>'><%# Eval("VehicleName")%></a></h3>
                                        <p><b>Vehicle Number:</b> <%# Eval("VehicleNumber")%></p>
                                        <p><b>Comment:</b> <%# Eval("Comment")%></p>
