<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="VehicleEntry.aspx.vb" Inherits="VehicleEntry" %>
    ...
    <div id="toolbar-box">
        <div class="m">
            <div class="toolbar-list" id="toolbar">
                <ul>
                    <li class="button" id="toolbar-new">
                        <a href="VehicleEntry.aspx" onclick="" class="toolbar">
                        <span class="icon-32-new"></span>New Vehicle</a>
                    </li>
            ...
            <div class="pagetitle icon-48-query">
                <h2>Vehicle Information<asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
    ...
    <div id="element-box">
        <div class="m">
            <div class="cpanel-left">
                ...
                <fieldset id="queryForm" title="Query The Database">
                  <ul class="queryList" style="width:58% !important;float:left">
                    <li>
                        <asp:Label id="lblPhone" for="txtVehicleNumber" title="" runat="server" ClientIDMode="Static">Vehicle Number:<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                            <asp:TextBox ID="txtVehicleNumber" runat="server"></asp:TextBox>
                        </div>
                    </li>
                    <li>
                        <asp:Label id="lblName" for="txtName" title="" runat="server" ClientIDMode="Static">Vehicle Name:<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
                      ...
                      <li>
                        <asp:Label id="lblAddress" for="txtComment" title="" runat="server" ClientIDMode="Static">Vehicle Description:<span class="star">&nbsp;*</span></asp:Label>
                        <div class="fltlft">
            ...
            <div class="cpanel-right">
                <div class="pane-sliders2" style="background:white">
                    <div class="panel"><div id="chart_div" style="height:230px;width:570px;font-size:14px;color:Blue;"><br /><br />Loading Vehicle History</div>
        ...
        <div class="m">
            <asp:GridView ID="gridViewBuses" runat="server" AutoGenerateColumns="False" TabIndex="1"
                ...
                <EmptyDataTemplate>
                    <span class="style1">No buses found recorded for the Vehicle. <br /> Did you know you can track Driver & Bus Activity from the Portal? Edit the Bus and Select The Driver to track them over time.</span>
                </EmptyDataTemplate>
