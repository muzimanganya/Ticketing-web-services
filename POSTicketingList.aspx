<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="POSTicketingList.aspx.vb" Inherits="POSTicketingList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
<title>POS Ticketing POS Per Bus</title>
...
<div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-traffic">
                <h2> <asp:Literal ID="posText" runat="server"></asp:Literal> Ticketing Details <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
      ...
      <div id="submenu-box">
			<div class="m">
				<ul id="submenu">
	            	<li><a href="POSTicketing.aspx">POS Ticketing Overview</a>	</li>
		            <li><a href="#" class="active">POS Ticketing Details</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
