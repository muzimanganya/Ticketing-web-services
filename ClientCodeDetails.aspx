<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="ClientCodeDetails.aspx.vb" Inherits="ClientCodeDetails" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
    <title>ClientCode Details</title>
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-query">
                <h2>View Client Code Details <asp:Literal ID="headerDate" runat="server"></asp:Literal> </h2>
            </div>
        </div>
    </div>
    <div id="submenu-box">
			<div class="m"> 
				<ul id="submenu">
		            ...
		            <li><a href="#" class="active" >Client Code Details</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
                ...
                <fieldset id="queryForm" title="Ticket Details">
                    <asp:Repeater ID="ticketDetails" runat="server">
                        ...
                        <ItemTemplate>
                                ...
                                <tr><td><b>Total Tickets: </b></td><td><asp:Label ID="lblHour" Text='<%# DataBinder.Eval(Container.DataItem, "TotalNormal")%>' runat="server"></asp:Label></td></tr>
                                <tr><td><b>Total Promotions: </b></td><td><asp:Label ID="lblPrice" Text='<%# DataBinder.Eval(Container.DataItem, "TotalPromo")%>' runat="server"></asp:Label></td></tr>
                                <tr><td><b>Total Bookings: </b></td><td><asp:Label ID="Label1" Text='<%# DataBinder.Eval(Container.DataItem, "TotalBooking")%>' runat="server"></asp:Label></td></tr>
                                </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                                </tbody>
