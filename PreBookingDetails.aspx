<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="PreBookingDetails.aspx.vb" Inherits="PrebookingDetails" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
    <title>Prebooking Details</title>
                ...
                <fieldset id="queryForm" title="Ticket Details">
                    <asp:Repeater ID="ticketDetails" runat="server">
                        ...
                        <ItemTemplate>
                                ...
                                <tr><td><b>BookingNo:</b> </td><td><i><asp:Label ID="lblTicketID" Text='<%# DataBinder.Eval(Container.DataItem, "BookingNo")%>' runat="server"></asp:Label></i></td></tr>
                                ...
                                <tr><td><b>Created On: </b></td><td><asp:Label ID="Label1" Text='<%# DataBinder.Eval(Container.DataItem, "CreatedOn")%>' runat="server"></asp:Label></td></tr>
                                <tr><td><b>Expires On: </b></td><td><asp:Label ID="Label2" Text='<%# DataBinder.Eval(Container.DataItem, "Expires")%>' runat="server"></asp:Label></td></tr>
                                <tr><td><b>Completed: </b></td><td><asp:Label ID="Label3" Text='<%# DataBinder.Eval(Container.DataItem, "Completed")%>' runat="server"></asp:Label></td></tr>
                                <tr><td><b>Reconciled: </b></td><td><asp:Label ID="Label4" Text='<%# DataBinder.Eval(Container.DataItem, "Recon")%>' runat="server"></asp:Label></td></tr>
                                </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                                </tbody>
                    ...
                    <%--<% If Completed = False Then%>
                        <asp:Button ID="btnCancelPreBooking" runat="server" Text="Cancel Prebooking!" 
                            OnClientClick="JavaScript:alert('Deleting the Prebooking. Please wait? \n\nPlease note that any action in this system is logged.')" 
                            style="clear:both"/>
                    <%End If%>--%>
