<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="RolledBackTickets.aspx.vb" Inherits="RolledBackTickets" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
    <title>Tickets Rolled Back By Webservice</title>
    ...
    <div id="submenu-box">
			<div class="m">
				<ul id="submenu">
                    ...
                    <li><a href="#" class="active">Daily Rolled-Back Traffic</a>	</li>
	            </ul>
				<div class="clr"></div>
			</div>
	</div>
            ...
            <asp:GridView ID="gridViewBuses" runat="server" AutoGenerateColumns="False" TabIndex="1"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ticket ID">
                        <ItemTemplate>
                            <a href='RolledTicketDetails.aspx?TicketID= <%# Eval("IDRELATION" )%>'><%# Eval("IDRELATION")%></a>
                        </ItemTemplate>
