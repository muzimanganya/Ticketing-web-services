...
Partial Class DeletedTicketDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Try
                ...
                Dim query As String =
                    String.Format("SELECT sp.IDRELATION,sp.DATE_MOD AS 'DateOfTravel',Description as 'Username',sp.FLD215 AS 'Circuit',sp.FLD109 AS 'Hour',sp.Total,sp.FLD111 AS 'Traveler',FLD191 AS 'ClientCode',s.NAME AS 'BusName'" &
                                    "FROM su.USER_ROLLED_SALES_PROD AS sp INNER JOIN su.SALES AS s ON sp.IDSALE = s.IDSALE" &
