...
Imports System.Data
Partial Class RolledBackTickets
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If String.IsNullOrEmpty(reqDate) Then
            ...
            query = "SELECT sl.IDSALE,sp.FLD120+'-'+sp.FLD122 AS 'Route','System' AS 'Username',sl.NAME as 'BusName',sl.Memo AS 'BusMemo',sl.DATE_CREAT,sl.FLD103 AS 'Capacity',sl.FLD163 AS 'Hour',sp.IDRELATION,sp.FLD120 as 'CityIN',sp.FLD122 as 'CityOut',sp.PRICE,sp.FLD191 as 'ClientCode',sp.FLD111 as 'ClientName'," &
                                "sp.DISCOUNT,sp.Total,sp.FLD213 AS 'Subscriptiono',sp.DATE_MOD AS 'CreatedOn',sp.FLD123 AS 'CreatedBy'" &
                                    " FROM su.SALES as sl INNER JOIN su.ROLLED_SALES_PROD as sp" &
        ...
        Else
            ...
            Try
                ...
                query = String.Format("SELECT sl.IDSALE,sp.FLD120+'-'+sp.FLD122 AS 'Route',sl.Memo AS 'BusMemo','System' AS 'UserName',sl.NAME as 'BusName',sl.DATE_CREAT,sl.FLD103 AS 'Capacity',sl.FLD163 AS 'Hour',sp.IDRELATION,sp.FLD120 as 'CityIN',sp.FLD122 as 'CityOut',sp.PRICE,sp.FLD191 as 'ClientCode',sp.FLD111 as 'ClientName'," &
                                "sp.DISCOUNT,sp.Total,sp.FLD213 AS 'Subscriptiono',sp.DATE_MOD AS 'CreatedOn',sp.FLD123 AS 'CreatedBy'" &
                                    " FROM su.SALES as sl INNER JOIN su.ROLLED_SALES_PROD as sp" &
        ...
        busname.Text = "Rolled Back Tickets"
