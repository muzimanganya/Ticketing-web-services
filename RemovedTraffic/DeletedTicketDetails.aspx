<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="DeletedTicketDetails.aspx.vb" Inherits="DeletedTicketDetails" %>
    ...
    <div id="element-box">
        <div class="m">
           ...
           <div class="cpanel-right">
               ...
               <div style="background:white">
                   <p>You can use query Database Utility to See Tickets Deleted On an earlier date</p>
