            ...
            <div class="toolbar-list" id="toolbar">
                <ul>
                    ...
                    <li class="button" id="Li2">
                        <a href="Seats/SeatsAllocation.aspx?idsale=<%=Request.QueryString("idsale") %>" onclick="" class="toolbar">
                        <span>
                             <img src="/Styles/icon-48-stats.png" width="32px" />
                        </span>Seats Allocation</a>  
                    </li>
                    <li class="divider"></li>
    ...
    <div id="element-box">
        ...
        <div style="padding:15px;margin-top:10px;" class="m">
            ...
            <asp:GridView ID="grvPrebookings" runat="server" AutoGenerateColumns="false" TabIndex="2"
                ...
                BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" ShowHeader="false" OnRowCreated="grvPrebookings_RowCreated" OnRowDataBound="grvPrebookings_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField DataField="Passport" HeaderText="Passport" HeaderStyle-CssClass="alignCenter">
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="UserName" HeaderText="Username" HeaderStyle-CssClass="alignCenter">
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:BoundField>
